...
template <class C1> bool utf8_to_utf16LE(C1 utf16, const char *utf8)
{
    uint32_t unicode;
...
template <class C1> bool utf8_to_utf16LE(C1 utf16, const std::u8string &utf8)
{
    uint32_t unicode;
    uint8_t len;
...
template <typename C1, typename C2> bool utf16LE_to_utf8(C1 utf8, C2 utf16)
{
    uint32_t unicode;
    uint8_t len;
    do
